# -*- coding: utf-8 -*-
"""
Created on Sun Aug 21 10:12:54 2022
...
def predict():
    ...
    if models==0:
        model=pickle.load(open('Major_college_DT_1.pkl','rb'))
        
    elif models==1:
        model=pickle.load(open('Major_college_RF_1.pkl','rb'))
        
    elif models==2:
        model=pickle.load(open('Major_college_KNN_1.pkl','rb'))
       
    elif models==3:
        model=pickle.load(open('Major_college_NB_1.pkl','rb'))
        
    elif models==4:
        model=pickle.load(open('Major_college_SVM_1.pkl','rb'))
